...
class PCVRHyFormerRankingTrainer:
    ...
    def train(self) -> None:
        ...
        for epoch in range(1, self.num_epochs + 1):
            ...
            # vocab_size is above the configured threshold as a cold restart to
            # reduce overfit. threshold=0 follows the platform baseline: reset
            # almost all non-empty sparse Embeddings.
